...
To make it easier to choose a web host for your site, we've compiled a list of web hosts that play nice with Nova 2 out of the box (and warnings about some that don't) that you can see [here](https://github.com/anodyne/hosts). You should also look at [Nova 2's requirements](/docs/2.7/requirements) *before* selecting a web host.
