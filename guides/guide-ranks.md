...
![Ranks Management](/docs/2.6/images/using-ranks/management-ranks.png)
...
![Rank Sets and Classes](/docs/2.6/images/using-ranks/ranks-sets-classes.png)
...
2. Click **Add A Rank**. A dialog box (also called a modal) will appear.
    ![Add Rank](/docs/2.6/images/using-ranks/rank-addrank.png)
...
![Modifying a rank](/docs/2.6/images/using-ranks/rank-modify.png)
...
![Blank rank](/docs/2.6/images/using-ranks/rank-blankrank.png)
...
![Accessing Rank Catalogue](/docs/2.6/images/using-ranks/controlpanel-rankcatalogue.png)
...
![Install Rankset](/docs/2.6/images/using-ranks/rankcatalogue-install.png)
...
![Site Settings](/docs/2.6/images/using-ranks/sitemanagement-settings.png)
...
![Display Options](/docs/2.6/images/using-ranks/sitesettings-displayoptions.png)
...
1. At the top of the page, find the **Dashboard** icon.
    ![Dashboard](/docs/2.6/images/using-ranks/dashboard.png)
2. A popup (modal) will appear in the center of the screen. Select **Edit Site Preferences**.
    ![Dashboard Modal](/docs/2.6/images/using-ranks/dashboard-sitepreferences.png)
3. Select the **My Ranks** tab.
    ![Select Your Rank](/docs/2.6/images/using-ranks/siteoptions-myranks.png)
