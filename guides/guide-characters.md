...
![Joining from main page](/docs/2.6/images/using-characters/join-main.png)
...
![Joining from manifest](/docs/2.6/images/using-characters/join-manifest.png)
...
![Edit bio](/docs/2.6/images/using-characters/edit-character.png)
...
![Dashboard](/docs/2.6/images/using-characters/dashboard.png)
...
2. Click on **Upload Images**.
    ![Upload Images](/docs/2.6/images/using-characters/image-upload.png)
3. Upload your image(s) one at a time, being sure to select **Mission Image** as the Image Type.
    ![Upload Character Images](/docs/2.6/images/using-characters/image-choose.png)
...
7. Locate your image(s) and click **Select Image**
    ![Select Image](/docs/2.6/images/using-characters/image-use.png)
...
![Characters submenu](/docs/2.6/images/using-characters/create-location.png)
...
![Link Characters](/docs/2.6/images/using-characters/link-location.png)

Select the username from the provided list.
![User List](/docs/2.6/images/using-characters/link-selectuser.png)
...
![Add Character](/docs/2.6/images/using-characters/link-assign.png)
...
![Secondary Character connected](/docs/2.6/images/using-characters/link-finished.png)
