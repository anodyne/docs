...
![Site manifests location](/docs/2.6/images/using-manifests/manifests-location.png)
...
![Metadata location](/docs/2.6/images/using-manifests/metadata-location.png)
...
![Departments location](/docs/2.6/images/using-manifests/departments-location.png)
...
![Departments page](/docs/2.6/images/using-manifests/departments-page.png)

To add a department, select the *Add Department* option.
![Add department](/docs/2.6/images/using-manifests/departments-add.png)
...
![Assign departments](/docs/2.6/images/using-manifests/departments-assign.png)
...
![Arrange departments](/docs/2.6/images/using-manifests/departments-arrange.png)
...
![Departments location](/docs/2.6/images/using-manifests/positions-location.png)
