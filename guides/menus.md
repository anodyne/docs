...
To access all menu categories within Nova, access the Menu Items page, and select *Manage Menu Categories*.

{% screenshot src="/images/docs/2.7/using-menus/categories-manage.png" alt="manage menu categories" /%}
...
{% screenshot src="/images/docs/2.7/using-menus/categories-add.png" alt="add a menu category" /%}
...
{% screenshot src="/images/docs/2.7/using-menus/menu-tabs.png" alt="menu item tabs" /%}
...
{% screenshot src="/images/docs/2.7/using-menus/menu-add.png" alt="add menu item" /%}
