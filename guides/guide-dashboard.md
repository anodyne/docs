...
![Dashboard location](/docs/2.6/images/using-dashboard/dashboard-location.png)

A typical dashboard will appear like this:
![Dashboard location](/docs/2.6/images/using-dashboard/dashboard.png)
...
![Custom links](/docs/2.6/images/using-dashboard/dashboard-mylinks.png)
...
![Delete your account](/docs/2.6/images/using-dashboard/dashboard-delete.png)
